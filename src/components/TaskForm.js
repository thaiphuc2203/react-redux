    ...
    return (
      <div className="panel panel-warning">
        <div className="panel-heading">
          <h3 className="panel-title"> { id !== ''? 'Update Work':"Add Work"} <Icon type="plus-circle" onClick={this.onCloseForm}/> </h3>
        ...
        <div className="panel-body">
          <form onSubmit={this.onSubmit}>
            ...
            <div className="text-center">
              <Button type="primary" htmlType="submit"> <i className="far fa-edit"></i>&nbsp; Add</Button>
               &nbsp;
              <Button type="danger" htmlType="button" onClick={this.onClear}> <i className="far fa-window-close"></i> &nbsp; Cancel</Button>
            </div>
          </form>
        </div>
      </div>
